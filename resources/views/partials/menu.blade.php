    ...
    <ul class="is-meta">
      ...
      <li>
        ...
        <div class="my-8x lg:mb-16x" style="display: none">
          <p>Tragen Sie Ihre E-Mail-Adresse in das Eingabefeld und Sie erhalten umgehend ein E-Mail mit einem Bestätigungslink. Klicken Sie auf den Link, um Ihre E-Mail Adresse zu aktivieren.</p>
