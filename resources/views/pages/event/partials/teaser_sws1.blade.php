<article class="text-media">
  <figure class="lg:span-6">
    <picture>
      <img 
        data-src="/assets/media/faw_stadtwerkstatt_1_teaser.jpg" 
        width="900" 
        height="600" 
        title="" 
  ...
  <div class="lg:span-6">
    ...
    <div class="text-media__links">
      <x-link-page 
      url="{{ route('page.event.workshop', ['slug' => 'stadtwerkstatt-1']) }}" 
      target="_self" 
      text="Ergebnisse und Erkenntnisse" 
      title="Ergebnisse und Erkenntnisse • Stadtwerkstatt 1"
      cssClass="mb-2x" />
    </div>
  </div>
</article>