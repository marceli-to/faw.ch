<article class="text-media">
  <figure class="lg:span-6">
    <picture>
      <img 
        data-src="/assets/media/faw_stadtwerkstatt_2_teaser.jpg" 
        width="900" 
        height="600" 
        title="" 
  ...
  <div class="lg:span-6" data-id="stadtwerkstatt-2">
    <x-heading 
      type="h2" 
      title="Stadtwerkstatt 2" 
      subtitle="Freiraum erleben und nutzen<br>8. März UND 10. März 2018"
    />
    ...
    <div class="text-media__links">
      <x-link-page 
      url="{{ route('page.event.workshop.show', ['slug' => 'stadtwerkstatt-2']) }}" 
      target="_self" 
      text="Ergebnisse und Erkenntnisse" 
      title="Ergebnisse und Erkenntnisse • Stadtwerkstatt 2"
      cssClass="mb-2x" />
    </div>
  </div>
</article>